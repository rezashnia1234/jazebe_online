	...
	L.Routing.Localization = L.extend(L.Routing.Localization, {
		...
		'fa': {
			directions: {
				...
				SlightRight: 'اندکی راست',
				Right: 'راست',
				SharpRight: 'تندی راست',
				SlightLeft: 'اندکی چپ',
				Left: 'چپ',
				SharpLeft: 'تندی چپ',
				Uturn: 'دور بزنید'
			...
			instructions: {
				...
				'SlightLeft':
					['به آرامی به چپ بچرخید', ' به سمت {road}'],
				'WaypointReached':
				...
				'Fork': ['در تقاطع به سمت {modifier} بپیچید', ' به سمت {road}'],
				'Merge': ['Merge {modifier}', ' به سمت {road}'],
				'OnRamp': ['بر روی رمپ ، به سمت {modifier} بپیچید', ' به سمت {road}'],
				'OffRamp': ['از رمپ به سمت {modifier} خارج شوید', ' به سمت {road}'],
				'EndOfRoad': ['در انتهای مسیر به سمت {modifier} بپیچید', ' به سمت {road}'],
				'Onto': ' به سمت {road}',
			},
			formatOrder: function(n) {
				var i = n % 10 - 1,
		...
		'ar': {
			...
			instructions: {
				...
				'Head':
					['بأتجاه {dir}', ' في {road}'],
				'Continue':
					['في اتجاه {dir} استمر', ' في {road}'],
				'SlightRight':
					['استدرالى اليمين بلطف', ' باتجاه {road}'],
				'Right':
					['استدر الى اليمين', ' باتجاه {road}'],
				'SharpRight':
					['استدر الى اليمين بسرعة', ' باتجاه {road}'],
				'TurnAround':
					['استدر'],
				'SharpLeft':
					['استدر الى اليسار بسرعة', ' باتجاه ', ' باتجاه {road}'],
				'Left':
					['استدر الى اليسار', ' باتجاه {road}'],
				'SlightLeft':
					['استدر الى اليسار بلطف', ' باتجاه {road}'],
				'WaypointReached':
					['وصلت الى الموقع المحدد'],
				'Roundabout':
					['من الخروج {exitStr} اخرج', ' باتجاه {road}'],
				'DestinationReached':
					['وصلت الى المقصد'],
			},
			formatOrder: function(n) {
			...
			ui: {
				startPlaceholder: 'المبدأ',
				viaPlaceholder: 'نقطة المنتصف {viaNumber}',
				endPlaceholder: 'المقصد'
			}
		},
